...
# i.e., when Pydantic converts the SQLAlchemy returned object to FastAPI, only fields specified here will be present in the JSON response the front-end gets
#  |
#  |
# \|/
